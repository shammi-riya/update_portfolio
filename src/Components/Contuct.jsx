  ...
  return (
    <div className='py-20 lg:px-0 px-5'>
      ...
      >
        ...
        <section className=" bg-transparent py-8 dark:text-gray-50">
          <div className="grid  grid-cols-1  mx-auto  md:grid-cols-2 md:divide-x">
            <div className="py-6 md:py-0 px-2">
              <h1 className="text-5xl font-bold">Get in <span className='text-red-500'>touch</span></h1>
            ...
            <form ref={form} onSubmit={sendEmail}  className="flex flex-col py-6 space-y-6 md:py-0 md:px-6">
              ...
              <label className="block">
                <span className="mb-1 p-2 text-lg font-semibold">Message *</span>
                <textarea required rows="5" name='message' placeholder='Message'
                className="block w-full rounded-md text-white focus:ring focus:ri focus:ri bg-gray-600"></textarea>
              </label>
